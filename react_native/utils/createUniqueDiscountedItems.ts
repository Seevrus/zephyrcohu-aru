...
import { ContextReceiptItem } from '../providers/types/receipts-provider-types';
import calculateAmounts from './calculateAmounts';

export default function createUniqueDiscountedItems(items: ContextReceiptItem[]): ReceiptItem[] {
  return items.flatMap<ReceiptItem>((contextItem) => {
    ...
    const discountedItems: ReceiptItem[] = contextItem.selectedDiscounts.map((selectedDiscount) => {
